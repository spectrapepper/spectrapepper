...
spectrapepper could always use more documentation,
whether as part of the official spectrapepper docs,
in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
<https://github.com/enricgrau/spectrapepper/issues>.
...
3.  The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and
    for PyPy. Check <https://github.com/enricgrau/spectrapepper/pull_requests> and make sure that the tests pass for all
